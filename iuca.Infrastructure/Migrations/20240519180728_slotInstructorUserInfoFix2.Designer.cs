...
namespace iuca.Infrastructure.Migrations
{
    ...
    [Migration("20240519180728_slotInstructorUserInfoFix2")]
    partial class slotInstructorUserInfoFix2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iuca.Domain.Entities.Common.AttendanceFolder", b =>
                {
                    ...
                    b.Property<string>("MainSpreadsheetId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("iuca.Domain.Entities.Common.EnvarSetting", b =>
                {
                    ...
                    b.Property<DateTime>("LastAttendanceUpdate")
            ...
            modelBuilder.Entity("iuca.Domain.Entities.Courses.ProposalCourse", b =>
                {
                    ...
                    b.Property<IEnumerable<int>>("YearsOfStudyJson")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("iuca.Domain.Entities.Slots.LessonPeriod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("iuca.Domain.Entities.Slots.LessonRoom", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("LessonRooms");
                });

            modelBuilder.Entity("iuca.Domain.Entities.Slots.Slot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int?>("InstructorUserId1")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("LessonPeriodId")
                        .HasColumnType("integer");

                    b.Property<Guid>("LessonRoomId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("InstructorUserId1");

                    b.HasIndex("LessonPeriodId");

                    b.HasIndex("LessonRoomId");
            ...
            modelBuilder.Entity("iuca.Domain.Entities.Slots.Slot", b =>
                {
                    ...
                    b.HasOne("iuca.Domain.Entities.Users.Students.DepartmentGroup", "Group")
                        .WithMany()
                    ...
                    b.HasOne("iuca.Domain.Entities.Users.UserInfo.UserBasicInfo", "InstructorUser")
                        .WithMany()
                        .HasForeignKey("InstructorUserId1");

                    b.HasOne("iuca.Domain.Entities.Slots.LessonPeriod", "LessonPeriod")
                        .WithMany()
                        .HasForeignKey("LessonPeriodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("iuca.Domain.Entities.Slots.LessonRoom", "LessonRoom")
                        .WithMany()
                        .HasForeignKey("LessonRoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("LessonPeriod");

                    b.Navigation("LessonRoom");
