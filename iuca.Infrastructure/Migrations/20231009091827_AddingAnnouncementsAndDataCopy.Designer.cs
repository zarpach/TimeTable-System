...
namespace iuca.Infrastructure.Migrations
{
    ...
    [Migration("20231009091827_AddingAnnouncementsAndDataCopy")]
    partial class AddingAnnouncementsAndDataCopy
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iuca.Domain.Entities.Courses.AnnouncementSectionStudent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("StudentUserId", "AnnouncementSectionId")
                        .IsUnique();

                    b.ToTable("AnnouncementSectionStudent");
                });
            ...
            modelBuilder.Entity("iuca.Domain.Entities.Courses.ExtraInstructor", b =>
                {
                    b.Property<int>("RegistrationCourseId")
                        .HasColumnType("integer")
                        .HasColumnName("AnnouncementSectionId");

                    b.Property<string>("InstructorUserId")
                        .HasColumnType("text");

                    b.HasKey("RegistrationCourseId", "InstructorUserId");
            ...
            modelBuilder.Entity("iuca.Domain.Entities.Courses.StudyCardCourse", b =>
                {
                    ...
                    b.HasIndex("RegistrationCourseId", "StudyCardId")
                        .IsUnique();
            ...
            modelBuilder.Entity("iuca.Domain.Entities.Courses.AnnouncementSectionStudent", b =>
                {
                    b.HasOne("iuca.Domain.Entities.Courses.RegistrationCourse", "AnnouncementSection")
                        .WithMany("AnnouncementSectionStudents")
            ...
            modelBuilder.Entity("iuca.Domain.Entities.Courses.Syllabus", b =>
                {
                    b.HasOne("iuca.Domain.Entities.Courses.RegistrationCourse", "RegistrationCourse")
                        .WithOne("Syllabus")
                        .HasForeignKey("iuca.Domain.Entities.Courses.Syllabus", "RegistrationCourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("iuca.Domain.Entities.Courses.RegistrationCourse", b =>
                {
                    b.Navigation("AnnouncementSectionStudents");
