...
namespace iuca.Infrastructure.Migrations
{
    ...
    [Migration("20230801051202_AddingDebtAmountField")]
    partial class AddingDebtAmountField
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iuca.Domain.Entities.Courses.Syllabus", b =>
                {
                    ...
                    b.Property<string>("RequiredTexts")
                        .IsRequired()
                        .HasMaxLength(5000)
                        .HasColumnType("character varying(5000)");
            ...
            modelBuilder.Entity("iuca.Domain.Entities.Courses.Syllabus", b =>
                {
                    b.HasOne("iuca.Domain.Entities.Common.Language", null)
                        .WithMany("Syllabi")
                        .HasForeignKey("LanguageId");
